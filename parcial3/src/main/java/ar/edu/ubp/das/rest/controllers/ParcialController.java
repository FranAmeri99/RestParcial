...
public class ParcialController {
    ...
    @PostMapping(
    	      path="/temas_servicios",
    	      consumes={MediaType.MULTIPART_FORM_DATA_VALUE}
    	    )
    	    public ResponseEntity<List<TemaServicioBean>> getTemasServicios(TemaServicioCriteriaBean criteria) {
    	        return new ResponseEntity<>(repository.getTemasServicios(criteria), HttpStatus.OK);
    	    }
